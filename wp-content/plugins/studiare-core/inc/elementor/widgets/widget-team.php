...
class tijarah_Widget_Team extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Team', 'studiare-core' );
   }
   ...
   protected function register_controls() {
      $this->start_controls_section(
         'team_section',
         [
            'label' => esc_html__( 'team', 'studiare-core' ),
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __( 'John Doe', 'studiare-core' ),
         ]
      );
      $this->add_control(
         'designation',
         [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __( 'App Developer', 'studiare-core' ),
         ]
      );
      ...
      $social->add_control(
         'social_icon', [
            'label' => __( 'Social Icon', 'studiare-core' ),
      ...
      $social->add_control(
         'social_url', [
            'label' => __( 'Socia URL', 'studiare-core' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '#',
         ]
      );
      ...
      $this->add_control(
         'social_media',
         [
            'label' => __( 'social profile', 'studiare-core' ),
