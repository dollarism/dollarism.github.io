...
class studiare_Widget_Test_Carousel extends Widget_Base
{

    public function get_name()
    {
        return 'test-carousel';
    }

    public function get_title()
    {
        return esc_html__('Carousel Latest Tests', 'studiare-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new studiare_Widget_Test_Carousel());
