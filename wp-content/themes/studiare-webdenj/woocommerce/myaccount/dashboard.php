...
if ( class_exists( 'Redux' ) ) {
 	$instagram_link = codebean_option('instagram_link');
	$telegram_link = codebean_option('telegram_link');
    $youtube_link = codebean_option('youtube_link');
    $aparat_link = codebean_option('aparat_link');
 }
