...
<div class="mini-cart-bottom" >
    <p class="woocommerce-mini-cart__total total"><strong><?php esc_html_e( 'Subtotal', 'studiare' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message">
		...
		<?php esc_html_e( 'No products in the cart.', 'studiare' ); ?>
	</p>
