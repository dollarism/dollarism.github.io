	...
	<div class="woocommerce-cart-holder">
		...
		<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
			...
			<tr>
				...
				<th class="product-subtotal"><?php esc_html_e( 'Total', 'studiare' ); ?></th>
			</tr>
			</thead>
			<tbody>
