	...
	class Redux_Import_Export extends Redux_Field {
		...
		public function enqueue() {
			wp_enqueue_script(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/extensions/import_export/import_export/redux-import-export' . Redux_Functions::is_min() . '.js',
				array(
					'jquery',
					'redux-js',
				),
			...
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style(
					'redux-import-export',
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/redux-import-export.css',
					array(),
					Redux_Extension_Import_Export::$version
				);
			}
