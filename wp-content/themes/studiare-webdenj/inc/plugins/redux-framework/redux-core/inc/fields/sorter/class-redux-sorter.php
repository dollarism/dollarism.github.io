		...
		public function enqueue() {
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style(
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/sorter/redux-sorter.css',
					array(),
					$this->timestamp
				);
			}
			...
			wp_enqueue_script(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/sorter/redux-sorter' . Redux_Functions::is_min() . '.js',
