	...
	class Redux_Spacing extends Redux_Field {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/spacing/redux-spacing' . Redux_Functions::is_min() . '.js',
			...
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style(
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/spacing/redux-spacing.css',
					array(),
					$this->timestamp
				);
			}
