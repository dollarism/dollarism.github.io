	...
	class Redux_Enqueue extends Redux_Class {
		...
		public function frontend_init() {
			...
			if ( $core->args['elusive_frontend'] ) {
				wp_enqueue_style(
					'redux-elusive-icon',
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/vendor/elusive-icons.min.css',
					array(),
					Redux_Core::$version
				);
			}
		...
		private function register_styles( $core ) {
			...
			$css = get_template_directory_uri()  . "/inc/plugins/redux-framework/redux-core/assets/css/colors/$color_scheme/colors$this->min.css";
			...
			wp_enqueue_style(
				'redux-admin-css',
				get_template_directory_uri()  . "/inc/plugins/redux-framework/redux-core/assets/css/redux-admin$this->min.css",
			...
			if ( ! $core->args['dev_mode'] ) {
				wp_enqueue_style(
					'redux-fields-css',
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/redux-fields.min.css',
					array(),
					$this->timestamp
				);
			}
			...
			wp_enqueue_style(
				'select2-css',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/vendor/select2.min.css',
				array(),
				'4.1.0'
			);
			...
			wp_register_style(
				'redux-spectrum-css',
				get_template_directory_uri()  . "/inc/plugins/redux-framework/redux-core/assets/css/vendor/spectrum$this->min.css",
				array(),
				'1.3.3'
			);
			...
			wp_enqueue_style(
				'redux-elusive-icon',
				get_template_directory_uri()  . "/inc/plugins/redux-framework/redux-core/assets/css/vendor/elusive-icons$this->min.css",
				array(),
				$this->timestamp
			);
			...
			wp_register_style(
				'font-awesome',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/font-awesome/css/all.min.css',
				array(),
				'6.1.1'
			);
			...
			wp_register_style(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/font-awesome/css/v4-shims.min.css',
				array(),
				'6.1.1'
			);
			...
			wp_enqueue_style(
				'qtip-css',
				get_template_directory_uri()  . "/inc/plugins/redux-framework/redux-core/assets/css/vendor/qtip$this->min.css",
				array(),
				'3.0.3'
			);
			...
			wp_enqueue_style(
				...
				// phpcs:ignore WordPress.NamingConventions.ValidHookName
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/vendor/jquery-ui-1.10.0.custom.css'
				),
				array(),
				$this->timestamp
			);
			...
			if ( $core->args['dev_mode'] ) {
				...
				wp_enqueue_style(
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/media.css',
					array(),
					$this->timestamp
				);
			}
			...
			if ( is_rtl() ) {
				wp_enqueue_style(
					'redux-rtl-css',
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/css/rtl.css',
		...
		private function register_scripts() {
			...
			wp_register_script(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/vendor/select2-sortable/redux.select2.sortable' . $this->min . '.js',
			...
			wp_enqueue_script(
				'select2-js',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/vendor/select2/select2' . $this->min . '.js`',
			...
			wp_enqueue_script(
				'qtip-js',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/vendor/qtip/qtip' . $this->min . '.js',
				array( 'jquery' ),
				'3.0.3',
				true
			);
			...
			if ( ! wp_script_is( 'redux-wp-color-picker-alpha-js' ) ) {
				...
				wp_register_script(
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/vendor/wp-color-picker-alpha/wp-color-picker-alpha' . $this->min . '.js',
			...
			wp_register_script(
				'redux-spectrum-js',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/vendor/spectrum/redux-spectrum' . $this->min . '.js',
				array( 'jquery' ),
				'1.3.3',
				true
			);
			...
			wp_register_script(
				'redux-vendor',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/redux-vendors' . $this->min . '.js',
				array( 'jquery' ),
				$this->timestamp,
				true
			);
			...
			wp_register_script(
				'redux-js',
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/js/redux' . $this->min . '.js',
