	...
	class Redux_Background extends Redux_Field {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/background/redux-background' . Redux_Functions::is_min() . '.js',
				$dep_array,
				$this->timestamp,
				true
			);
			...
			if ( $this->parent->args['dev_mode'] ) {
				wp_enqueue_style(
					...
					get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/inc/fields/background/redux-background.css',
					array(),
					$this->timestamp
				);
