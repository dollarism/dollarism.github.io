		...
		'fields'     => array(
			array(
				...
				'options'  => array(
					...
					'4' => array(
						'alt' => '3 Column Middle',
						'img' => get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/img/3cm.png',
					),
					'5' => array(
						'alt' => '3 Column Left',
						'img' => get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/img/3cl.png',
					),
					'6' => array(
						'alt' => '3 Column Right',
						'img' => get_template_directory_uri()  . '/inc/plugins/redux-framework/redux-core/assets/img/3cr.png',
					),
				),
				'default'  => '2',
			),
