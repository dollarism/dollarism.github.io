...
if ( ! function_exists( 'woodmart_add_section_full_width_control' ) ) {
	...
	function woodmart_add_section_full_width_control( $element ) {
		$element->start_controls_section(
			'wd_extra_layout',
			[
				'label' => esc_html__( 'کشیدگی ردیف', 'woodmart' ),
		...
		$element->add_control(
			...
			[
				...
				'default'      => 'disabled',
				'options'      => array(
					'disabled'        => esc_html__( 'غیرفعال', 'woodmart' ),
					'stretch'         => esc_html__( 'کشیدگی بخش', 'woodmart' ),
					'stretch-content' => esc_html__( 'کشیدگی بخش و محتوا', 'woodmart' ),
				),
