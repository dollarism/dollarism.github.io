 ...
 */
class Studiare_Widget_Price_Filter extends WC_Widget {
			...
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<div class="price_label" style="display:none;">
						' . esc_html__( '', 'woocommerce' ) . ' <span class="to"></span> &mdash; <span class="from"></span>
					</div>
					<button type="submit" class="button">' . esc_html__( 'فیلتر کن!', 'woocommerce' ) . '</button>
