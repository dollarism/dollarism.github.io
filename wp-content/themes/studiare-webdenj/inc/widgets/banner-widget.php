 ...
 * @see WP_Widget
 */
class WP_Widget_Text_Banner extends WP_Widget {
    ...
    parent::__construct(
			'widget_text_banner',
			esc_html__('ابزارک بدون حاشیه سفید', 'studiare'),
			array( 'description' => esc_html__( 'برای نداشتن حاشیه سفید از این ابزارک استفاده کنید.', 'studiare' ), )
		);
	}
	...
	public function _register_one( $number = -1 ) {
		...
		add_action( 'admin_footer-widgets.php', array( 'WP_Widget_Text_Banner', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$widget_text_do_shortcode_priority       = has_filter( 'widget_text_banner', 'do_shortcode' );
		$should_suspend_legacy_shortcode_support = ( $is_visual_text_widget && false !== $widget_text_do_shortcode_priority );
		if ( $should_suspend_legacy_shortcode_support ) {
			remove_filter( 'widget_text_banner', 'do_shortcode', $widget_text_do_shortcode_priority );
		}
		 ...
		 */
		$text = apply_filters( 'widget_text_banner', $text, $instance, $this );
		...
		if ( $should_suspend_legacy_shortcode_support ) {
			add_filter( 'widget_text_banner', 'do_shortcode', $widget_text_do_shortcode_priority );
		}
		...
		?>
			<div class="textwidget banner-image-widget"><?php echo $text; ?></div>
		<?php
...
function register_contacts_widget_banner() {
	register_widget( 'WP_Widget_Text_Banner' );
}
add_action( 'widgets_init', 'register_contacts_widget_banner' );
